...
const I18N = {
  ko: {
    ...
    "pack.guard.confirmLeaveRunning": "패킹이 아직 진행 중입니다. 이 화면을 벗어나도 서버에서는 계속 진행되지만, 나중에 다시 돌아오지 않으면 결과를 검토/저장하지 못할 수 있습니다. 그래도 이동할까요?",
    "pack.guard.offerStopAndSave": "지금까지 진행된 내용을 저장(체크포인트)하고 중단할까요? 취소를 누르면 백그라운드에서 계속 진행됩니다.",
    "pack.title": "패킹 진행 상황",
    "pack.log": "로그",
  ...
  en: {
    ...
    "pack.guard.confirmLeaveRunning": "Packing is still in progress. Leaving this screen won't stop it on the server, but if you don't come back later you may not get to review/save the result. Leave anyway?",
    "pack.guard.offerStopAndSave": "Save progress so far (checkpoint) and stop now? Choose Cancel to keep it running in the background.",
