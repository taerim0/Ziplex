...
const I18N = {
  ko: {
    ...
    "options.openaiBaseUrlPlaceholder": "예: http://localhost:11434/v1 (Ollama) — 비우면 OpenAI 공식 서버",
  ...
  en: {
    ...
    "options.openaiBaseUrlPlaceholder": "e.g. http://localhost:11434/v1 (Ollama) — blank defaults to OpenAI's own server",
